...
```bash
INIT=$(~/.claude/skills/dev-skills/bin/gsd/gsd-sdk.js query docs-init)
if [[ "$INIT" == @file:* ]]; then INIT=$(cat "${INIT#@file:}"); fi
AGENT_SKILLS=$(~/.claude/skills/dev-skills/bin/gsd/gsd-sdk.js query agent-skills gsd-doc-writer)
```
...
```bash
~/.claude/skills/dev-skills/bin/gsd/gsd-sdk.js query commit "docs: generate project documentation" \
