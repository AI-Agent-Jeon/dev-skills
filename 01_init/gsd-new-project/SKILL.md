...
```bash
INIT=$(~/.claude/skills/dev-skills/bin/gsd/gsd-sdk.js query init.new-project)
if [[ "$INIT" == @file:* ]]; then INIT=$(cat "${INIT#@file:}"); fi
AGENT_SKILLS_RESEARCHER=$(~/.claude/skills/dev-skills/bin/gsd/gsd-sdk.js query agent-skills gsd-project-researcher)
AGENT_SKILLS_SYNTHESIZER=$(~/.claude/skills/dev-skills/bin/gsd/gsd-sdk.js query agent-skills gsd-research-synthesizer)
AGENT_SKILLS_ROADMAPPER=$(~/.claude/skills/dev-skills/bin/gsd/gsd-sdk.js query agent-skills gsd-roadmapper)
```
...
```bash
mkdir -p .planning
~/.claude/skills/dev-skills/bin/gsd/gsd-sdk.js query config-new-project '{"mode":"yolo","granularity":"[selected]","parallelization":true|false,"commit_docs":true|false,"model_profile":"quality|balanced|budget|inherit","workflow":{"research":true|false,"plan_check":true|false,"verifier":true|false,"nyquist_validation":true|false,"auto_advance":true}}'
```
...
```bash
mkdir -p .planning
~/.claude/skills/dev-skills/bin/gsd/gsd-sdk.js query commit "chore: add project config" --files .planning/config.json
```
...
```bash
mkdir -p .planning
~/.claude/skills/dev-skills/bin/gsd/gsd-sdk.js query commit "docs: initialize project" --files .planning/PROJECT.md
```
...
```bash
mkdir -p .planning
~/.claude/skills/dev-skills/bin/gsd/gsd-sdk.js query config-new-project '{"mode":"[yolo|interactive]","granularity":"[selected]","parallelization":true|false,"commit_docs":true|false,"model_profile":"quality|balanced|budget|inherit","workflow":{"research":true|false,"plan_check":true|false,"verifier":true|false,"nyquist_validation":[false if granularity=coarse, true otherwise]}}'
```
...
```bash
~/.claude/skills/dev-skills/bin/gsd/gsd-sdk.js query commit "docs: define v1 requirements" --files .planning/REQUIREMENTS.md
```
...
```bash
~/.claude/skills/dev-skills/bin/gsd/gsd-sdk.js query generate-claude-md --output "$INSTRUCTION_FILE"
```
...
```bash
~/.claude/skills/dev-skills/bin/gsd/gsd-sdk.js query commit "docs: create roadmap ([N] phases)" --files .planning/ROADMAP.md .planning/STATE.md .planning/REQUIREMENTS.md "$INSTRUCTION_FILE"
```
...
```bash
PHASE1_SECTION=$(~/.claude/skills/dev-skills/bin/gsd/gsd-sdk.js query roadmap.get-phase 1 2>/dev/null)
